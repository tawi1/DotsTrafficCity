...
#. In the :ref:`Road Parent <roadParentInfo>`, press the `Force connect` button if you have created :ref:`new segments <roadSegmentCreator>` (make sure all segments are :ref:`on one line <trafficNodeConnectionInfo>`).
