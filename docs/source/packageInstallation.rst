...
#. Make sure that you have **Unity 2022.3.21+** (except **2022.3.40**, **2022.3.41**, **2022.3.42**, **2022.3.43**, **2022.3.44**, **2022.3.45**, **2022.3.46** which are `currently broken <https://discussions.unity.com/t/missing-prefab-references-when-baking-a-subscene/1502057>`_).
